...
<?php
		...
		echo "<li><a href='index.php ?p={$row->cat_id}' class='selected' title='{$row->cat_des}'> {$row->cat_name} </a>
		</li>";
	}
...
<?php
		...
		echo "<li><a href='index.php ?p={$row->product_id}' class='selected' title='{$row->shortdesc}'> {$row->title} </a>
		</li>";
	}
